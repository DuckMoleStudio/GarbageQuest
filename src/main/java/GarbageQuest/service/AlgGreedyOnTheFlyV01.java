...
public class AlgGreedyOnTheFlyV01 {
    public static Result Calculate(List<WayPoint> wayPoints, int avgSpeed, int carCapacity){

        Result result = new Result();
        result.setMethodUsed("Simple Greedy Algorithm, on the fly distance calculation, V.01");
