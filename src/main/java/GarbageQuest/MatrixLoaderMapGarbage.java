...
public class MatrixLoaderMapGarbage {
    public static void main(String[] args) {
        ...
        String filter = "район Фили-Давыдково"; // "Северо-Восточный административный округ", ...
        ...
        String jsonOutputFile = "C:\\Users\\User\\Documents\\GD\\fili.json";
        ...
        Map<WayPoint,MatrixLineMap> matrix = Matrix.FillGHMulti4Map(
                wayPointList, osmFile, dir, false, false, false);
